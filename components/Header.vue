...
const isTransparent = computed(() =>
  isAtTop.value && route.path === "/" && !menuOpen.value
);
function toggleMenu() {
...
const handleScroll = () => {
  ...
  if (menuOpen.value && currentScrollY !== lastScrollY) {
    menuOpen.value = false;
  }
  ...
  <header id="nav" :class="['nav-bar', { hidden: !showNavbar, transparent: isTransparent }]">
    ...
    <div class="navbar-inner d-flex align-items-center px-3">
      ...
      <div class="nav-links d-none d-lg-flex align-items-center">
        <NuxtLink class="nav-link text-uppercase fw-bold" to="/">
          Rólunk
        </NuxtLink>
        <NuxtLink class="nav-link text-uppercase fw-bold" to="/webshop">
          Webshop
        </NuxtLink>
        <NuxtLink class="nav-link text-uppercase fw-bold" to="/lovaink">
          Lovaink
        </NuxtLink>
        <NuxtLink class="nav-link text-uppercase fw-bold" to="/eredmenyeink">
          Eredményeink
        </NuxtLink>
        <NuxtLink class="nav-link text-uppercase fw-bold" to="/rendeles-kovetes">
          Rendelés követése
        </NuxtLink>
        <NuxtLink class="nav-link text-uppercase fw-bold" to="/kapcsolat">
          Kapcsolat
        </NuxtLink>
      </div>
    ...
    <div :class="['mobile-menu', { 'menu-open': menuOpen }]">
      <nav class="d-flex flex-column">
        <NuxtLink class="mobile-link" to="/" @click="closeMenu">Rólunk</NuxtLink>
        <NuxtLink class="mobile-link" to="/webshop" @click="closeMenu">Webshop</NuxtLink>
        <NuxtLink class="mobile-link" to="/lovaink" @click="closeMenu">Lovaink</NuxtLink>
        <NuxtLink class="mobile-link" to="/eredmenyeink" @click="closeMenu">Eredményeink</NuxtLink>
        <NuxtLink class="mobile-link" to="/rendeles-kovetes" @click="closeMenu">Rendelés követése</NuxtLink>
        <NuxtLink class="mobile-link" to="/kapcsolat" @click="closeMenu">Kapcsolat</NuxtLink>
        <NuxtLink
          v-if="!isAuthenticated"
          class="mobile-link"
          to="/admin/login"
