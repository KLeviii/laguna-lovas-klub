    ...
    <main>
      <section class="p-3 p-md-5" style="padding-top: 100px !important;">
        ...
        <div v-if="isCartEmpty" class="text-center py-5">
          ...
          <NuxtLink to="/webshop" class="btn btn-primary mt-2">
            ...
            <div class="col-12 col-md-5 col-lg-4">
              <div class="card shadow-sm">
                <div class="card-body">
                  ...
                  <NuxtLink to="/penztar" class="btn btn-primary w-100">
                    <i class="bi bi-credit-card me-1"></i>
                    Tovább a pénztárhoz
                  </NuxtLink>
                  <NuxtLink to="/webshop" class="btn btn-outline-secondary w-100 mt-2">
