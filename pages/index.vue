  ...
  <div class="hero-container">
    ...
    <section class="hero-section d-flex align-items-center justify-content-center text-center">
      ...
      <div class="hero-content position-relative">
        <h1 class="hero-title mb-4">
          Lovas <em class="serif-accent hero-accent">hagyomány</em>,<br />
      ...
      <div class="container-xl ">
        ...
        <div v-else-if="horses.length > 0" class="row g-3">
          ...
          <div class="col-12 col-md-7 reveal">
            <NuxtLink :to="`/lovaink/${horses[0].id}`" class="horse-card-link">
        ...
        <div class="text-center mt-5 reveal">
          <NuxtLink to="/lovaink" class="btn btn-primary btn-lg px-5">
            Összes lovunk
    ...
    <section class="results-section section-padding">
      <div class="container">
        ...
        <div class="text-center mt-5 reveal">
          <NuxtLink to="/eredmenyeink" class="btn btn-primary btn-lg px-5">
            Összes eredmény
            <i class="bi bi-arrow-right ms-2"></i>
          </NuxtLink>
        </div>
      ...
      <div class="container">
        <div class="cta-box text-center reveal">
          ...
          <div class="cta-content">
            ...
            <NuxtLink to="/kapcsolat" class="btn btn-primary btn-lg px-5">
              Kapcsolatfelvétel
